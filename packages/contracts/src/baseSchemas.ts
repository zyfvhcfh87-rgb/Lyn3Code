...
export const RoutingDecisionId = makeEntityId("RoutingDecisionId");
...
export const VerificationProfileId = makeEntityId("VerificationProfileId");
export type VerificationProfileId = typeof VerificationProfileId.Type;
export const VerificationGateId = makeEntityId("VerificationGateId");
export type VerificationGateId = typeof VerificationGateId.Type;
export const VerificationCheckDefinitionId = makeEntityId("VerificationCheckDefinitionId");
export type VerificationCheckDefinitionId = typeof VerificationCheckDefinitionId.Type;
export const VerificationRunId = makeEntityId("VerificationRunId");
export type VerificationRunId = typeof VerificationRunId.Type;
export const VerificationCheckRunId = makeEntityId("VerificationCheckRunId");
export type VerificationCheckRunId = typeof VerificationCheckRunId.Type;
export const VerificationDiagnosticId = makeEntityId("VerificationDiagnosticId");
export type VerificationDiagnosticId = typeof VerificationDiagnosticId.Type;
export const VerificationArtifactId = makeEntityId("VerificationArtifactId");
export type VerificationArtifactId = typeof VerificationArtifactId.Type;
export const VerificationRepairAttemptId = makeEntityId("VerificationRepairAttemptId");
export type VerificationRepairAttemptId = typeof VerificationRepairAttemptId.Type;
export const VerificationOverrideId = makeEntityId("VerificationOverrideId");
export type VerificationOverrideId = typeof VerificationOverrideId.Type;
