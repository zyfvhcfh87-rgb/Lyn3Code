...
const buildAppUnderTest = (options?: {
  ...
  layers?: {
    ...
    routingCoordinator?: Partial<RoutingCoordinator.RoutingCoordinator["Service"]>;
    ...
    const servedRoutesLayer = HttpRouter.serve(
      ...
      Layer.provide(
        Layer.mergeAll(
          ...
          Layer.mock(RoutingCoordinator.RoutingCoordinator)({
            ...options?.layers?.routingCoordinator,
          }),
        ),
      ),
      Layer.provide(
