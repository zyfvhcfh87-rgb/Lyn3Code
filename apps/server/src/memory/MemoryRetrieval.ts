        ...
        rankingMetadata: {
          ...
          selected: [
            ...selected.memories.map((memory) => ({
              ...
              memoryType: memory.entry.type,
              scopeType: memory.entry.scopeType,
              trustLevel: memory.entry.trustLevel,
              status: memory.entry.status,
            ...
            ...selected.excerpts.map((excerpt) => ({
              ...
              startLine: excerpt.startLine,
              endLine: excerpt.endLine,
              commitHash: excerpt.commitHash,
              branchName: excerpt.branchName,
              score: excerpt.score,
