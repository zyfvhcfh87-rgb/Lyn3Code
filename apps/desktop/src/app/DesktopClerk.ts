...
export const make = Effect.gen(function* () {
  ...
  // directory here. Otherwise the lock would be acquired under the
  // productName-derived "Lyn Code (Alpha)" path before migration can select
  // the stable `t3code` directory or an existing pre-rebrand installation.
